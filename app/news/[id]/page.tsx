...
const TRANSLATIONS = {
  back: { mn: "Мэдээ рүү буцах", en: "Back to Feed" },
  published: { mn: "Нийтлэгдсэн", en: "Published on" },
  author: { mn: "Бичсэн", en: "By" },
  share: { mn: "Хуваалцах", en: "Share" },
  subscribe: { mn: "Бүртгүүлэх", en: "Stay in the loop" },
  readingTime: { mn: "минут уншина", en: "min read" }
};
        ...
        <div className="max-w-4xl mb-16">
           <div className="flex items-center gap-3 text-[#00aeef] mb-6">
              ...
              <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest opacity-60">
                 <Clock size={12} />
                 {getReadingTime(article.content[lang])} {TRANSLATIONS.readingTime[lang]}
              </div>
           </div>
           ...
           <aside className="lg:col-span-4">
              <div className="sticky top-32 space-y-10">
                 ...
                 <div className={`relative p-8 rounded-[3rem] overflow-hidden group
                    ...
                    <h4 className="text-2xl font-black tracking-tight mb-3 leading-tight">{TRANSLATIONS.subscribe[lang]}</h4>
                    <p className="text-xs font-bold opacity-80 mb-8 leading-relaxed">
                       Don't miss the next update. Join 1,200+ members in our weekly digest.
                    </p>
                 ...
                 <div className="px-6 flex items-center justify-between opacity-40">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-[10px] font-black uppercase tracking-widest">Comments (0)</span>
                    </div>
                    <Link href="#" className="text-[10px] font-black uppercase tracking-widest hover:text-[#00aeef]">Write</Link>
                 </div>
