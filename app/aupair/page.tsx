...
const DATA = {
  hero: {
    title: "Au-Pair Хөтөлбөр",
    sub: "Гадаадад амьдарч, шинэ соёл, хэл сурах, туршлага хуримтлуулах боломж.",
    cta: "Форм бөглөх"
  },
  stats: [
  ...
  benefits: [
    { icon: FaGlobeEurope, title: "Туршлага", desc: "Гадаадад амьдрах бодит туршлага." },
    { icon: FaLanguage, title: "Хэл Эзэмших", desc: "Гадаад хэлийг орчинд нь төгс сурах." },
    { icon: FaPlaneDeparture, title: "Аялал", desc: "Европоор чөлөөтэй аялах боломж." },
    { icon: FaMoneyBillWave, title: "Орлого", desc: "Өөрийн халаасны мөнгөө олно." },
    { icon: FaUniversity, title: "CV Баяжуулах", desc: "Ирээдүйн карьерт том давуу тал." },
    { icon: FaUsers, title: "Найз Нөхөд", desc: "Олон улсын өргөн танилтай болно." },
  ],
  steps: [
    { id: "01", title: "Герман Хэл", desc: "Германыг сонгосон бол А1 түвшин хангаж, Гёте шалгалт өгөх." },
    { id: "02", title: "Сургалт & Материал", desc: "ECAPS стандартын дагуу бичиг баримт бүрдүүлж, чиглүүлэх сургалтад хамрагдах." },
    { id: "03", title: "Ажлын Байр", desc: "Зочин айлтай холбогдож, ярилцлага хийн гэрээ баталгаажуулах." },
    { id: "04", title: "Виз Мэдүүлэх", desc: "ЭСЯ-нд виз мэдүүлэх зөвлөгөө, зааварчилгааг мэргэжлийн түвшинд авах." },
    { id: "05", title: "Аялал", desc: "Виз авсны дараах аяллын бэлтгэл, онгоцны тийз, угтан авах үйлчилгээ." },
  ]
};
