...
const TRANSLATIONS = {
  back: { mn: "Арга хэмжээ рүү буцах", en: "Back to Events" },
  date: { mn: "Огноо", en: "Date" },
  time: { mn: "Цаг", en: "Time" },
  location: { mn: "Байршил", en: "Location" },
  category: { mn: "Төрөл", en: "Category" },
  share: { mn: "Хуваалцах", en: "Share" },
  join: { mn: "Бүртгүүлэх", en: "Register Now" },
  joined: { mn: "Бүртгэгдсэн", en: "Registered" },
  attendees: { mn: "Оролцогчид", en: "Attendees" },
  university: { mn: "Сургууль", en: "University" },
  loginRequired: { mn: "Нэвтрэх шаардлагатай", en: "Login Required" }
};
...
export default function EventDetailPage() {
  ...
  const eventDate = new Date(event.date).toLocaleDateString(lang === 'mn' ? 'mn-MN' : 'en-US', {
    year: 'numeric',
    month: 'long',
    day: 'numeric'
  });
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mb-12">
           <Link href="/events" className={`group inline-flex items-center gap-3 px-5 py-2.5 rounded-full border transition-all
              ...
              <span className="text-[10px] font-black uppercase tracking-widest">{TRANSLATIONS.back[lang]}</span>
           </Link>
        </div>
        ...
        <div className="max-w-4xl mb-16">
           <div className="flex flex-wrap items-center gap-4 text-[#00aeef] mb-8">
              ...
              <div className={`flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest ${isDark ? "text-white/60" : "text-slate-500"}`}>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex items-start gap-4">
                 ...
                 <div>
                    <p className={`text-[10px] font-black uppercase tracking-widest opacity-40 mb-1`}>{TRANSLATIONS.date[lang]}</p>
              ...
              <div className="flex items-start gap-4">
                 ...
                 <div>
                    <p className={`text-[10px] font-black uppercase tracking-widest opacity-40 mb-1`}>{TRANSLATIONS.time[lang]}</p>
              ...
              <div className="flex items-start gap-4">
                 ...
                 <div>
                    <p className={`text-[10px] font-black uppercase tracking-widest opacity-40 mb-1`}>{TRANSLATIONS.location[lang]}</p>
                    <p className="text-sm font-bold">{event.location[lang]}</p>
                 </div>
              </div>
           </div>
        </div>
              ...
              <div className="sticky top-32 space-y-10">
                 ...
                 <div className={`p-8 rounded-[3rem] border transition-all
                    ...
                    <h4 className="text-2xl font-black tracking-tight mb-3 leading-tight">
                       {hasJoined ? (lang === 'mn' ? 'Бүртгэл амжилттай!' : 'Joined Successfully!') : 'Ready to join?'}
                    </h4>
                    <p className="text-xs font-bold opacity-80 mb-8 leading-relaxed">
                       {hasJoined 
                         ? (lang === 'mn' ? 'Та энэ арга хэмжээнд амжилттай бүртгэгдлээ. Удахгүй уулзацгаая!' : 'You are registered for this event. See you there!')
                         : (lang === 'mn' ? 'Арга хэмжээнд оролцох суудлаа баталгаажуулаарай. Суудал хязгаартай!' : 'Secure your spot for this event. Limited seats available!')}
                    </p>
                    ...
                    >
                       ...
                       {hasJoined ? TRANSLATIONS.joined[lang] : TRANSLATIONS.join[lang]}
                    </button>
                    
                    <div className="mt-6 flex items-center justify-between opacity-80">
                       <div className="flex items-center gap-2">
                          <Users size={14} />
                          <span className="text-[10px] font-black uppercase tracking-widest">{event.attendees?.length || 0} {TRANSLATIONS.attendees[lang]}</span>
                       </div>
                 ...
                 <div className={`p-8 rounded-[3rem] border transition-all
                    ...
                    <h4 className="text-[11px] font-black uppercase tracking-[0.2em] mb-8 text-[#00aeef]">{TRANSLATIONS.share[lang]}</h4>
