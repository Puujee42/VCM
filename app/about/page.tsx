...
const aboutData = {
  mn: {
    ...
    intro: "Бид 20 жилийн туршлагаараа 3,000 гаруй залуусыг дэлхийн соёлтой танилцуулж, амжилтын түүхийг хамт бүтээлцлээ. Au Pair хөтөлбөрөөр дамжуулан бид танд Европын орнуудад амьдрангаа хэл сурч, хувь хүнээ хөгжүүлэх шилдэг боломжийг олгож байна.",
    
    storyTitle: "Германаас эхлэлтэй амжилтын түүх",
    ...
    storyP2: "Тэрбээр Германд зочин айлын хүүхдийг асарч, соёл уламжлалтай танилцан, хэлний мэдлэгээ сайжруулж, хувь хүнийхээ хувьд хөгжин, ирээдүйг харах шинэ өнцгийг олж авсан. Энэхүү үр шимийг эх орныхоо залууст хуваалцах чин хүслээр энэхүү байгууллагыг байгуулж, дэлхийн стандартыг Монголд нэвтрүүлсэн билээ.",
