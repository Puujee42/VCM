                      ...
                      <div className="flex gap-3 overflow-x-auto pb-4 no-scrollbar">
                         {DATES.map((d) => (
                            <button
                               ...
                               className={`min-w-20 p-4 rounded-3xl border-2 flex flex-col items-center justify-center transition-all ${
                                  formData.date?.date === d.date 
               ...
               {step < 3 ? (
                  <button 
                     ...
                     className={`px-8 py-3 rounded-xl font-bold text-white shadow-lg flex items-center gap-2 transition-all ${
                        (step === 1 && !formData.service) || (step === 2 && (!formData.date || !formData.time))
                  ...
                  <button className="px-10 py-3 rounded-xl bg-emerald-500 text-white font-black uppercase tracking-wider shadow-lg hover:bg-emerald-600 hover:scale-105 transition-all flex items-center gap-2">
                     Баталгаажуулах <CheckCircle2 size={20} />
                  </button>
               )}
            </div>
